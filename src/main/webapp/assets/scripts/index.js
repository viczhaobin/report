    ...
    return {
        ...
        initCharts: function () {
            ...
            function showTooltip(title, x, y, contents) {
                $('<div id="tooltip" class="chart-tooltip"><div class="date">' + title + '<\/div><div class="label label-danger">产量: ' + x + '<\/div><div class="label label-success">达产率: ' + (30*x/y).toFixed(0) + '%<\/div><\/div>').css({
                    position: 'absolute',
                    display: 'none',
                    top: y - 100,
                    width: 80,
            ...
            function showTooltip2(title, x, y, contents) {
                $('<div id="tooltip" class="chart-tooltip"><div class="date">' + title + '<\/div><div class="label label-success">FTT: ' + (30*x/y).toFixed(0) + '%<\/div><\/div>').css({
                    position: 'absolute',
                    display: 'none',
                    top: y - 100,
                    width: 80,
                ...
                $("#site_statistics").bind("plothover", function (event, pos, item) {
                    ...
                    if (item) {
                        if (previousPoint != item.dataIndex) {
                            ...
                            showTooltip('2018年8月', item.pageX, item.pageY, item.series.label + " of " + x + " = " + y);
                        }
                    } else {
                        $("#tooltip").remove();
                        previousPoint = null;
                ...
                $("#site_activities").bind("plothover", function (event, pos, item) {
                    ...
                    if (item) {
                        if (previousPoint2 != item.dataIndex) {
                            ...
                            var x = item.datapoint[0].toFixed(2),
                                y = item.datapoint[1].toFixed(2);
                            showTooltip2('2018年8月', item.pageX, item.pageY, x);
                        }
                    }
                });
        ...
        initMiniCharts: function () {
            ...
            $("#sparkline_line2").sparkline([9,11,12,13,12,13,10,14,13,11,11,12,11,11,10,12,11,10], {
                type: 'line',
                width: '100',
                height: '55',
                lineColor: '#ffb848'}
